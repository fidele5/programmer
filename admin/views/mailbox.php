...
?>
 <!--  BEGIN CUSTOM STYLE FILE  -->
    <link rel="stylesheet" type="text/css" href="public/plugins/editors/quill/quill.snow.css">
    <link href="public/assets/css/apps/mailbox.css" rel="stylesheet" type="text/css" />
                                    ...
                                    <div id="mailbox-inbox" class="accordion mailbox-inbox">
                                        ...
                                        <div class="message-box">
                                            ...
                                            <div class="message-box-scroll" id="ct">
                                                ...
                                                <?php
                                                    foreach ($utilisateurs as  $received) {
                                                        ?>
                                                <div class="mail-item sentmail">
                                                    <div class="animated animatedFadeInUp fadeInUp" id="mailHeading<?=$received["id"]?>">
                                                        <div class="mb-0">
                                                            <div class="mail-item-heading work collapsed"  data-toggle="collapse" role="navigation" data-target="#mailCollapse<?=$received["id"]?>" aria-expanded="false">
                                                                <div class="mail-item-inner">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="f-body">
                                                                            <div class="meta-mail-time">
                                                                                <p class="user-email" data-mailTo="<?=$received["email"]?>"><?= $received["nom_complet"]?></p>
                                                                            </div>
                                                                            <div class="meta-title-tag">
                                                            ...
                                                            <div class="mail-item-heading social collapsed"  data-toggle="collapse" role="navigation" data-target="#mailCollapseThree" aria-expanded="false">
                                                                <div class="mail-item-inner">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="f-head">
                                                                            <img src="public/assets/img/profile-16.jpg" class="user-profile" alt="avatar">
                                                                        </div>
                                                                        <div class="f-body">
                                                                            <div class="meta-mail-time">
                                                            ...
                                                            <div class="mail-item-heading collapsed"  data-toggle="collapse" role="navigation" data-target="#mailCollapseSeven" aria-expanded="false">
                                                                <div class="mail-item-inner">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="f-head">
                                                                            <img src="public/assets/img/profile-17.jpg" class="user-profile" alt="avatar">
                                                                        </div>
                                                                        <div class="f-body">
                                                                            <div class="meta-mail-time">
                                                            ...
                                                            <div class="mail-item-heading collapsed"  data-toggle="collapse" role="navigation" data-target="#mailCollapseNine" aria-expanded="false">
                                                                <div class="mail-item-inner">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="f-head">
                                                                            <img src="public/assets/img/profile-18.jpg" class="user-profile" alt="avatar">
                                                                        </div>
                                                                        <div class="f-body">
                                                                            <div class="meta-mail-time">
                                                            ...
                                                            <div class="mail-item-heading collapsed"  data-toggle="collapse" role="navigation" data-target="#mailCollapseTen" aria-expanded="false">
                                                                <div class="mail-item-inner">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="f-head">
                                                                            <img src="public/assets/img/profile-13.jpg" class="user-profile" alt="avatar">
                                                                        </div>
                                                                        <div class="f-body">
                                                                            <div class="meta-mail-time">
                                                            ...
                                                            <div class="mail-item-heading collapsed"  data-toggle="collapse" role="navigation" data-target="#mailCollapseEighteen" aria-expanded="false">
                                                                <div class="mail-item-inner">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="f-head">
                                                                            <img src="public/assets/img/profile-23.jpg" class="user-profile" alt="avatar">
                                                                        </div>
                                                                        <div class="f-body">
                                                                            <div class="meta-mail-time">
                                        ...
                                        <div class="content-box">
                                            ...
                                            <?php
                                                foreach ($utilisateurs as $users) {
                                                    ?>
                                            <div id="mailCollapse<?=$users["id"]?>" class="collapse" aria-labelledby="mailHeading<?=$users["id"]?>" data-parent="#mailbox-inbox">
                                                <div class="mail-content-container sentmail" data-mailfrom="<?=$users["email"]?>" data-mailto="<?=$users["email"]?>" data-mailcc="">
                                                    ...
                                                    <div class="d-flex justify-content-between mb-3">
                                                        <div class="d-flex user-info">
                                                            <div class="f-body">
                                                                <div class="meta-mail-time">
                                                                    <div class="">
                                                                        <p class="user-email" data-mailto="<?=$users["email"]?>"><span>To,</span> <?=$users["email"]?></p>
                                                                    </div>
                                            ...
                                            <div id="mailCollapseThree" class="collapse" aria-labelledby="mailHeadingThree" data-parent="#mailbox-inbox">
                                                <div class="mail-content-container mailInbox" data-mailfrom="info@mail.com" data-mailto="linda@mail.com" data-mailcc="">
                                                    ...
                                                    <div class="gallery text-center">
                                                        <img alt="image-gallery" src="public/assets/img/scroll-6.jpg" class="img-fluid mb-4 mt-4" style="width: 250px; height: 180px;">
                                                        <img alt="image-gallery" src="public/assets/img/scroll-7.jpg" class="img-fluid mb-4 mt-4" style="width: 250px; height: 180px;">
                                                        <img alt="image-gallery" src="public/assets/img/scroll-8.jpg" class="img-fluid mb-4 mt-4" style="width: 250px; height: 180px;">
                                                    </div>
...
<!-- END GLOBAL MANDATORY SCRIPTS -->
    <script src="public/assets/js/ie11fix/fn.fix-padStart.js"></script>
    <script src="public/plugins/editors/quill/quill.js"></script>
